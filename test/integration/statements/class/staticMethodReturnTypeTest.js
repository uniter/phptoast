...
describe('PHP Parser grammar class definition statement static method return type integration', function () {
    var parser;
...
*/;}), // jshint ignore:line
        ...
        'empty static method definition with unnamespaced class return type but no statements': {
            code: nowdoc(function () {/*<<<EOS
<?php
    class Thing {
...
*/;}), // jshint ignore:line
        ...
        'empty static method definition with namespaced class return type but no statements': {
            code: nowdoc(function () {/*<<<EOS
<?php
    class Thing {
